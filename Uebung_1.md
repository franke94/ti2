...
gauss:
	...
	; (n+1) liegt nun in rax und soll mit n, also rdi multipliziert werden. Das Ergebnis liegt danach in rdx:rax.
	MUL rdi

	; Wir speichern den Divisor 2 in r11...
	MOV r11, 2

	; und dividieren mit DIV rdx:rax mit r11. Das Ergebnis liegt danach schon im Return-Register rax.
	DIV r11

	; Nun wird das Endergebnis mit RET zurückgegeben.
	RET
```
